...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2025 at 06:21 AM
...
CREATE TABLE `expedisi` (
  `kd_expedisi` varchar(10) NOT NULL,
...
INSERT INTO `expedisi` (`kd_expedisi`, `nama_expedisi`, `tujuan`, `ongkir`) VALUES
('3', 'test expedisi jne', 'sungailiat jne branch office', 32000);
